...
public class GameActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String riddle = getResources().getString(R.string.r2);
        tvRiddle.setText(riddle);
        ibnext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent nextRiddle = new Intent(GameActivity1.this, GameActivity2.class);
    ...
    private void gameButtons() {
        ...
        bOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String correctAns = getResources().getString(R.string.r2_ans);
