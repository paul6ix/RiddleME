...
public class GameActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String riddle = getResources().getString(R.string.r5);
        tvRiddle.setText(riddle);
        ibnext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent nextRiddle = new Intent(GameActivity4.this, GameActivity5.class);
    ...
    private void gameButtons() {
        ...
        bOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String correctAns = getResources().getString(R.string.r5_ans);
